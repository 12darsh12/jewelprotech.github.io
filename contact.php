...
<head>
    ...
    <!-- Title -->
    <title>Contact Us | JEWEL PRO TECH</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="page-wrapper">
            ...
            <div class="header-upper bg-white">
                <div class="container-fluid clearfix">
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        ...
                        <div class="nav-outer mx-auto clearfix">
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                   ...
                                   <li><a href="contact.php" style="color:#20B933;">Contact Us</a>
                                    </ul>
                                </div>
                        ...
                        <!-- Menu Button -->
                        <div class="menu-btns">
                           <a href="contact.php" class="theme-btn">Get a Quote <i class="fas fa-long-arrow-right"></i></a>
                        </div>
                        
                        <!-- Header Social -->
                        <div class="social-style-two">
                                    <a href="https://www.facebook.com/jewelprotech"><i class="fab fa-facebook-f"></i></a>                                  
                                    <a href="https://www.instagram.com/jewelprotech/"><i class="fab fa-instagram"></i></a>
                                    <a href="https://www.linkedin.com/company/jewel-pro-tech-pvt-limited"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Page Banner Start -->
        <section class="page-banner-area bgs-cover py-135 rpy-100" style="background-image: url(assets/images/contact_banner.jpg);">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="contact-info-box wow fadeInUp delay-0-2s">
                            ...
                            <h4>Locations</h4>
                            <span>Surat office : 102 , Sargam Complex, Opp. Bhulka bhavan School , Adajan, Surat, 
...
Gujarat - 395009 </span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="contact-info-box wow fadeInUp delay-0-3s">
                            ...
                            <h4>Email Us</h4>
                            <a href="mailto: info@jewelprotech.com"> info@jewelprotech.com</a><br><br><br><br>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="contact-info-box wow fadeInUp delay-0-4s">
                            ...
                            <h4>Phone No.</h4>
                            <span>Mobile : <a href="callto:+91 9081766173">+91 9081766173</a></span>
                            <span>Mobile : <a href="callto:+91 7567339038">+91 7567339038</a></span><br><br><br>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="contact-info-box wow fadeInUp delay-0-5s">
                            ...
                            <span>09:00am - 05:00pm</span><br><br><br>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contact-page-map wow fadeInUp delay-0-2s">
            <div class="our-location">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14880.102055090412!2d72.798689!3d21.1911454!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04fec8807600f%3A0x2a3d7681ea1427fe!2sJewel%20Pro%20Tech%20Private%20Limited!5e0!3m2!1sen!2sin!4v1676972695696!5m2!1sen!2sin" style="border:0; width: 100%;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" id="f_name" name="f_name" class="form-control" value="" placeholder="First name" required data-error="Please enter your name">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" id="l_name" name="l_name" class="form-control" value="" placeholder="Last name" required data-error="Please enter your name">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea name="messages" id="messages" class="form-control" rows="3" placeholder="Message" required data-error="Please enter your Message"></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="form-group text-center mb-0">
                                    <button type="submit" value="submit" class="theme-btn style-two">send message <i class="far fa-long-arrow-right"></i></button>
       ...
       <footer class="main-footer bgc-gray footer-white rel z-1">
            <div class="footer-cta-wrap">
                <div class="container">
                    <div class="footer-cta-inner bgs-cover" style="background-image: url(assets/images/footer/footer-cta-bg.jpg);">
                        ...
                        <a href="contact.php" class="theme-btn style-three wow fadeInRight delay-0-2s">Get Free Quote <i class="fas fa-long-arrow-right"></i></a>
                        <div class="hotline wow fadeInRight delay-0-2s">
                            <i class="fas fa-phone"></i>
                            <div class="content">
                                <span>Hotline</span><br>
                                <a href="callto:+91 9081766173">+91 9081766173</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row medium-gap">
                    <div class="col-xl-5">
                        <div class="footer-widget widget_about wow fadeInUp delay-0-2s">
                            ...
                            <p>Jewel pro tech's portfolio of diverse businesses makes a positive impact on a truly global scale. Our purpose is to help people live more fulfilling and productive lives and help organisations to connect more people to relevant business on a global scale with multiple career progression opportunities.</p>
                            
                            <a href="about.html" class="read-more">Learn More Us <i class="fas fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-4 order-xl-2">
                        <div class="footer-widget widget_newsletter wow fadeInUp delay-0-6s">
                            <h4 class="footer-title">Get in Touch</h4>
                            <p><b style="color:	#C8C8C8;">Surat office </b>: 102 , Sargam Complex, Opp. Bhulka bhavan School , Adajan, Surat, Gujarat - 395009 </p>
                            <p><b style="color:	#C8C8C8;">Head Office </b>: Diamond ICQ 1109-1110, 11/F Winfield Commercial Building, 6 Prat avenue, Tsim Sha Tsui , Hong Kong</p>
                            <p>+91 9081766173 / +91 7567339038</p>
                            <p> info@jewelprotech.com</p>
                        ...
                        <div class="row">
                                ...
                                <div class="footer-widget widget_nav_menu wow fadeInUp delay-0-3s">
                                    ...
                                    <ul class="list-style-two">
                                        ...
                                        <li><a href="work.php">Why Work Here</a></li>
            ...
            <div class="footer-bottom bgc-black mt-20 pt-20" style="padding-bottom:10px;">
                <div class="container">
                    <div class="row align-items-center">
                       
                        <div class="col-12">
                            <div class="copyright-text text-lg-end wow fadeInLeft delay-0-2s">
                                <p>Copyright ©2023 jewelprotech. All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
